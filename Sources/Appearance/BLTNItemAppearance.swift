...
@objc public class BLTNItemAppearance: NSObject {
    ...
    @objc public dynamic var actionButtonColor: UIColor = #colorLiteral(red: 0, green: 0.4784313725, blue: 1, alpha: 1)
    ...
    @objc public dynamic var alternativeButtonTitleColor: UIColor = #colorLiteral(red: 0, green: 0.4784313725, blue: 1, alpha: 1)
    ...
    @objc public dynamic var imageViewTintColor = #colorLiteral(red: 0, green: 0.4784313725, blue: 1, alpha: 1)

    /// The color of title text labels (default light gray).
    @objc public dynamic var titleTextColor = #colorLiteral(red: 0.568627451, green: 0.5647058824, blue: 0.5725490196, alpha: 1)

    /// The color of description text labels (default black).
    @objc public dynamic var descriptionTextColor = #colorLiteral(red: 0, green: 0, blue: 0, alpha: 1)
